Public Class Form1
    ...
    Private Sub update1()
        On Error Resume Next
        Dim s As String
        My.Computer.Network.DownloadFile("http://tofuture.qiniudn.com/Beta1.0.txt?" & downloadrandom, "networkinf.txt", "", "", False, 5000, True)
        If My.Computer.FileSystem.FileExists("networkinf.txt") Then
            FileOpen(11, "networkinf.txt", OpenMode.Input)
            s = LineInput(11)
            If s = "Yes" Then updateBool = True Else updateBool = False
            FileClose(11)
            My.Computer.FileSystem.DeleteFile("networkinf.txt")
        Else
            updateBool = False
        End If
        updatedone = True
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        updatedone = False
        updateBool = False
        downloadrandom = Rnd() * 100000
        thread1 = New Threading.Thread(AddressOf update1, 0)
        thread1.Start()
